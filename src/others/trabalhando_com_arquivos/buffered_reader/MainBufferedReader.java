package others.trabalhando_com_arquivos.buffered_reader;
...
//        handleFolderFiles();
    ...
    private static void usingBufferedReaderFileReader() {
        String path = "src/others/trabalhando_com_arquivos/in.txt";
    ...
    private static void usingBufferedWriterFileWriter() {
        ...
        String path = "src/others/trabalhando_com_arquivos/out.txt";
